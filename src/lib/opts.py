...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--exp_id', default='coco_resdcn18')
    ...
    self.parser.add_argument('--val_intervals', type=int, default=100000000,
    ...
    self.parser.add_argument('--keep_res', default='True',
  ...
  def init(self, args=''):
    default_dataset_info = {
      'ctdet': {'default_resolution': [720, 1280], 'num_classes': 1,
